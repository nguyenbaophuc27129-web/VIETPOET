    ...
    <div className="voice-chat flex flex-col h-full rounded-lg royal-border paper-texture relative" style={{ background: 'var(--paper-light)' }}>
      ...
      <div className="p-4 text-white rounded-t-lg" style={{ background: 'var(--primary)' }}>
        <div className="flex items-center justify-between mb-2">
          <h3 className="font-bold text-lg flex items-center gap-2" style={{ fontFamily: 'var(--font-serif)' }}>
      ...
      {/* Input */}
      <form onSubmit={handleSubmit} className="p-4 bg-white border-t flex gap-2" style={{ borderColor: 'var(--accent)' }}>
        ...
        <input
          ...
          placeholder={hasStarted ? "Nhập câu hỏi..." : "Nhấn BẮT DẦU để bắt đầu..."}
        ...
        <button
          ...
          className="px-6 py-2 rounded-lg text-white disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors"
        ...
        <button
          ...
          className="px-3 py-2 rounded-lg disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors"
